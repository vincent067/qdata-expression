...
class TestContextResolver:
    ...
    def test_merge_contexts(self, sample_context: dict):
        ...
        updates = {"user": {"name": "Bob", "new_field": "new_value"}, "new_top": "added"}
...
class TestConvenienceFunctions:
    ...
    def test_unflatten_context_function(self):
        ...
        flat = {"user.name": "Alice", "user.age": 30, "order.id": 123}
...
class TestEdgeCases:
    ...
    def test_mixed_types(self):
        ...
        mixed = {"data": [{"key": "value"}, [1, 2, 3], "string", 42]}
    ...
    def test_empty_and_none_values(self):
        ...
        data = {"empty_string": "", "none_value": None, "empty_list": [], "empty_dict": {}}
