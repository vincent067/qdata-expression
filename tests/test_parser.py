...
class TestExpressionBuilder:
    ...
    def test_operators(self):
        ...
        expr = builder.var("x").add().var("y").multiply().literal(2).build()
        assert expr == "x + y * 2"
    ...
    def test_comparison_operators(self):
        ...
        expr = builder.var("age").gt().literal(18).and_().var("age").lt().literal(65).build()
    ...
    def test_logical_operators(self):
        ...
        expr = builder.not_().var("condition").build()
    ...
    def test_complex_expression_building(self):
        ...
        expr = builder.func("if_else", condition.build(), '"adult"', '"minor"').build()
...
class TestParseResult:
    ...
    def test_parse_result_to_dict(self):
        ...
        result = ParseResult(
            expression="x + y", variables=["x", "y"], functions=["abs"], is_valid=True, errors=[]
        )
    ...
    def test_parse_result_with_errors(self):
        ...
        result = ParseResult(expression="2 +", is_valid=False, errors=["Syntax error"])
